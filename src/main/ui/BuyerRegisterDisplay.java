...
// Display the signing window for a new buyer
public class BuyerRegisterDisplay {
    JFrame frame;
    JTextField name;
    JTextField username;
    JTextField password;
    ...
    // EFFECTS : show a form with needed information for adding a new buyer
    public BuyerRegisterDisplay(Residences residences) {
        this.residences = residences;
        handler = new RegHandler();
        frame = new JFrame("Buyer Register Display");
    ...
    // A class for handling the actions of buyer register frame
    private class RegHandler implements ActionListener {

        // EFFECTS : register the buyer with given information when the button is pressed
        @Override
